...
export function VideoGrid() {
  const {
    ...
    clearSelection, setSelection, setFocusIndex, selectOnly, playFromList,
  ...
  const moveFocus = useCallback(
    ...
    [total, cols, virtualizer, anchorIndex, getRange, setSelection, selectOnly, setFocusIndex],
  );
  ...
  return (
    <div
      ...
      onClick={(e) => {
        // カード以外の余白クリックで選択解除
        if (!(e.target as HTMLElement).closest('.card, .list-row')) clearSelection();
      }}
    >
