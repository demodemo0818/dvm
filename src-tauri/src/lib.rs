...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::folders::list_excluded_paths,
            commands::folders::add_excluded_paths,
            commands::folders::remove_excluded_path,
            commands::folders::rescan_all,
            commands::videos::query_videos,
            commands::videos::count_videos,
            commands::videos::list_extensions,
            ...
            commands::playlists::get_videos_by_ids,
            commands::playlists::find_playlist_by_name,
            commands::playlists::create_playlist,
            commands::playlists::replace_playlist,
            commands::playlists::rename_playlist,
            commands::playlists::duplicate_playlist,
            commands::playlists::delete_playlist,
            commands::playlists::reorder_playlists,
            commands::playlists::get_queue_state,
            commands::playlists::set_queue_state,
            commands::playlists::export_m3u8,
            commands::playlists::import_m3u8,
